      ...
      - generic [ref=e30]:
        ...
        - generic [ref=e32]:
          ...
          - generic [ref=e35]:
            ...
            - generic [ref=e45]: Please verify your email before logging in
            - link "Go to verification page" [ref=e47] [cursor=pointer]:
              - /url: /verify-email
          - paragraph [ref=e49]:
            - text: Dont have an account?
            - link "Sign up as Student" [ref=e50] [cursor=pointer]:
              - /url: /register
    - contentinfo [ref=e51]:
      - paragraph [ref=e54]: © MentorMatch - Eldar Gafarov & Roee Bar. All rights reserved.
  - alert [ref=e55]
```