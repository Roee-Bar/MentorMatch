...
describe('SupervisorApplicationsPage', () => {
  ...
  // Test: Fetches applications on mount
  ...
  // Test: Displays all applications
  ...
  // Test: Filters applications by status - pending
  ...
  // Test: Filters applications by status - under_review
  ...
  // Test: Filters applications by status - approved
  ...
  // Test: Shows all applications when "All" filter is selected
  ...
  // Test: Active filter button is highlighted
