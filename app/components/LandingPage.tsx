...
import { btnPrimary, btnSecondary, heading3xl, textMuted } from '@/lib/styles/shared-styles';
    ...
    <div>
      ...
      <section className="bg-gradient-to-b from-blue-50 to-white py-20 px-12 text-center dark:from-slate-900 dark:to-slate-800">
        <div className="max-w-form mx-auto">
          <h1 className={`text-5xl font-bold ${heading3xl} mb-5 leading-tight`}>
            Find Your Perfect Project Supervisor
          </h1>
          
          <p className={`text-xl ${textMuted} mb-10 leading-relaxed text-balance`}>
