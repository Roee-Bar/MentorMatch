...
test.describe('Student - Partnerships @student @smoke @regression', () => {
  test('should display partnership status @smoke', async ({ page, authenticatedStudent }) => {
  ...
  test('should send partnership request @regression', async ({ page, authenticatedStudent }) => {
    const dashboard = new StudentDashboard(page);
